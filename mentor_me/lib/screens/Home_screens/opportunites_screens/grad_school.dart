...
class GradSchoolPage extends StatefulWidget {
  const GradSchoolPage({super.key});

  @override
  State<GradSchoolPage> createState() => _GradSchoolPageState();
}
...
class GradSchool extends StatefulWidget {
  const GradSchool({super.key});

  @override
  State<GradSchool> createState() => _GradSchoolState();
}

class _GradSchoolState extends State<GradSchool> {
  String searchVal = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => _postContent(user, 'grad_school_posts'),
        child: Icon(
          Icons.add,
          color: Colors.white,
        ),
